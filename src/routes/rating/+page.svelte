...
{:else}
	<div class="min-h-screen bg-base-200 flex flex-col">
		<div in:fly={{ y: -10, duration: 300 }} class="px-5 pt-14 pb-4 text-center max-w-2xl mx-auto w-full">
			<div class="text-[3rem] mb-2">&#127881;</div>
			<h1 class="text-[1.5rem] lg:text-[1.75rem] font-bold">How was your Rescue Box?</h1>
			<p class="text-base-content/60 text-[0.875rem] lg:text-[1rem] mt-1">Quick tap helps us make it better</p>
		</div>

		<div class="flex-1 flex flex-col items-center justify-center px-5 max-w-2xl mx-auto w-full">
			<div
