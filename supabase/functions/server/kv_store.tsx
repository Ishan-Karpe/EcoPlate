/**
 * KV Store - Supabase-backed key-value storage for EcoPlate.
 *
 * Table schema:
 *   CREATE TABLE kv_store_b2407c0b (
...
const TABLE = "kv_store_b2407c0b";

const client = () =>
  createClient(Deno.env.get("SUPABASE_URL")!, Deno.env.get("SUPABASE_SECRET_KEY")!);
